    ...
    <div className="flex min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <main className="flex-1 md:ml-64 relative">
        ...
        <div className="p-4 md:p-8 pt-24 md:pt-28 max-w-6xl mx-auto">
          ...
          {activeTab === 'settings' && <Settings user={user} currentTheme={currentTheme} onThemeChange={setCurrentTheme} isSundayOffEnabled={isSundayOffEnabled} onToggleSundayOff={() => setIsSundayOffEnabled(!isSundayOffEnabled)} isWeeklyScheduleEnabled={isWeeklyScheduleEnabled} onToggleWeeklySchedule={() => setIsWeeklyScheduleEnabled(!isWeeklyScheduleEnabled)} isMessagesTabEnabled={isMessagesTabEnabled} onToggleMessagesTab={() => setIsMessagesTabEnabled(!isMessagesTabEnabled)} onUpdateAvatar={(f) => {}} />}
