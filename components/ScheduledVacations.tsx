...
import { User, VacationSchedule, ThemeColor } from '../types';
import { CalendarPlus, User as UserIcon, Calendar, ArrowRight, Trash2, Palmtree, CheckCircle2, Clock } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-fade-in">
        <div className="flex items-center space-x-3">
            ...
            <div>
                <h2 className="text-xl font-bold text-slate-800">Agendamento de Férias</h2>
                <p className="text-sm text-slate-500">Programe as férias da equipe para ativação automática.</p>
            </div>
        </div>
                                            ...
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center text-xs text-slate-500 mt-1">
                                                        <span className={`px-2 py-0.5 rounded border ${getStatusColor(schedule.status)} font-bold text-[10px] uppercase`}>
